...
class NannyModeScanPage extends StatefulWidget {
  const NannyModeScanPage({Key? key}) : super(key: key);

  @override
  State<NannyModeScanPage> createState() => _NannyModeScanPageState();
}

class _NannyModeScanPageState extends State<NannyModeScanPage> {
  ...
  Future<void> _initCamera() async {
    try {
      ...
      debugPrint('NannyModeScanPage: Error initializing camera: $e');
      if (mounted) {

...
class SilverModeScanPage extends StatefulWidget {
  const SilverModeScanPage({Key? key}) : super(key: key);

  @override
  State<SilverModeScanPage> createState() => _SilverModeScanPageState();
}

class _SilverModeScanPageState extends State<SilverModeScanPage> {
  ...
  Future<void> _initCamera() async {
    try {
      ...
      debugPrint('SilverModeScanPage: Error initializing camera: $e');
      if (mounted) {
